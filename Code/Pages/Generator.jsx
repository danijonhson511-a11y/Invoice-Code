...
export default function Generator() {
  ...
  // Auto-save generated invoice to memory whenever it changes
  React.useEffect(() => {
    if (generatedInvoice) {
      ...
      <div className="relative z-10 min-h-screen p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          {!generatedInvoice && !showGeneratingAnimation ? (
            /* ... keep existing code (Prompt Input section) ... */
            ...
            /* ... keep existing code (AI Generation Animation) ... */
            ...
            /* ... keep existing code (Invoice Display) ... */
            <div>
              {isEditing ? (
                <InvoiceEdit
